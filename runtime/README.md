...
- [Architecture Health 0.1 Contracts](architecture-health/0.1/)
...
- `repo.architecture_health_scan` 通过本地 stdio MCP 运行项目自有 analyzer，归一化事实，核验必需证据来源和受保护约束变更，并返回基线棘轮结果；项目 profile、扫描器、约束和基线仍归目标项目所有。
