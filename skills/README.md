...
| `aios-tender-write` | 工程标书 / 技术标生成与改写：支持 Markdown 工作母版，也支持历史技术标 docx 母版保真改写的七步中文动作，并交回 `aios-tender-audit` 复核。 |
...
| `aios-tender-write` | 工程标书 / 技术标生成与改写，用于生成目录、章节初稿、评分点响应内容、历史素材复用表，也可用中文动作控制历史 docx 母版保真改写。 |
